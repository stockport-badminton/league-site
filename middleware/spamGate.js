...
// sent when it wasn't. That is why the checks are only the ones with negligible false
// positive rates — an unfilled hidden field and a three-second floor — and why every
...
function respondBland(req, res) {
  ...
  return res.status(200).render('contact-us-form-delivered', {
    ...
    pageTitle: 'Contact Us - Message Sent',
    pageDescription: 'Your message has been sent',
