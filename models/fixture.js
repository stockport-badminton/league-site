...
exports.sendResultZap = function(zapObject,done){
  if (db.isObject(zapObject) && (zapObject.host !== '127.0.0.1:3000' || typeof zapObject.host === 'undefined')){
    var options = {
      ...
      body:{
        "imgGen":"https://stockport-badminton.co.uk/resultImage/"+zapObject.homeTeam+"/"+zapObject.homeTeam+"/"+zapObject.homeScore+"/"+zapObject.awayScore+"/"+zapObject.division,
