...
exports.validateMesserScorecard = [
  ...
  body('Game1awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 1: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 1: one team must score at least 21'),
  body('Game2homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game2awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 2: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 2: one team must score at least 21'),
  body('Game3homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game3awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 3: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 3: one team must score at least 21'),
  body('Game4homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game4awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 4: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 4: one team must score at least 21'),
  body('Game5homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game5awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 5: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 5: one team must score at least 21'),
  body('Game6homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game6awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 6: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 6: one team must score at least 21'),
  body('Game7homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game7awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 7: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 7: one team must score at least 21'),
  body('Game8homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game8awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 8: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 8: one team must score at least 21'),
  body('Game9homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game9awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 9: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 9: one team must score at least 21'),
  body('Game10homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game10awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 10: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 10: one team must score at least 21'),
  body('Game11homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game11awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 11: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 11: one team must score at least 21'),
  body('Game12homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game12awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 12: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 12: one team must score at least 21'),
  body('Game13homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game13awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 13: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 13: one team must score at least 21'),
  body('Game14homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game14awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 14: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 14: one team must score at least 21'),
  body('Game15homeScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30'),
  body('Game15awayScore').isInt({ min: 0, max: 30 }).withMessage('must be between 0 and 30').custom(differenceOfTwo).withMessage('Game 15: winning score must be 2 greater than losing').custom(greaterThan21).withMessage('Game 15: one team must score at least 21'),
  // Player uniqueness validation
  body('homeMan1', 'Please choose a player.').isInt().custom((value, { req }) => {
    return value != 0 ? (value == req.body.homeMan2 || value == req.body.awayMan1 || value == req.body.awayMan2) ? false : value : value;
  ...
  body('homeMan2', 'Please choose a player.').isInt().custom((value, { req }) => {
    return value != 0 ? (value == req.body.homeMan1 || value == req.body.awayMan1 || value == req.body.awayMan2) ? false : value : value;
  ...
  body('homeLady1', 'Please choose a player.').isInt().custom((value, { req }) => {
    return value != 0 ? (value == req.body.homeLady2 || value == req.body.awayLady1 || value == req.body.awayLady2) ? false : value : value;
  ...
  body('homeLady2', 'Please choose a player.').isInt().custom((value, { req }) => {
    return value != 0 ? (value == req.body.homeLady1 || value == req.body.awayLady1 || value == req.body.awayLady2) ? false : value : value;
  ...
  body('awayMan1', 'Please choose a player.').isInt().custom((value, { req }) => {
    return value != 0 ? (value == req.body.homeMan1 || value == req.body.homeMan2 || value == req.body.awayMan2) ? false : value : value;
  ...
  body('awayMan2', 'Please choose a player.').isInt().custom((value, { req }) => {
    return value != 0 ? (value == req.body.homeMan1 || value == req.body.homeMan2 || value == req.body.awayMan1) ? false : value : value;
  ...
  body('awayLady1', 'Please choose a player.').isInt().custom((value, { req }) => {
    return value != 0 ? (value == req.body.homeLady1 || value == req.body.homeLady2 || value == req.body.awayLady2) ? false : value : value;
  ...
  body('awayLady2', 'Please choose a player.').isInt().custom((value, { req }) => {
    return value != 0 ? (value == req.body.homeLady1 || value == req.body.homeLady2 || value == req.body.awayLady1) ? false : value : value;
...
exports.full_messer_fixture_post = async function(req, res, next) {
  ...
  try {
    ...
    const scorecardData = {
      ...
      FirstMixedhomeMan: req.body.FirstMixedhomeMan1,
      FirstMixedhomeLady: req.body.FirstMixedhomeLady1,
      FirstMixedawayMan: req.body.FirstMixedawayMan1,
      FirstMixedawayLady: req.body.FirstMixedawayLady1,
      SecondMixedhomeMan: req.body.SecondMixedhomeMan2,
      SecondMixedhomeLady: req.body.SecondMixedhomeLady2,
      SecondMixedawayMan: req.body.SecondMixedawayMan2,
      SecondMixedawayLady: req.body.SecondMixedawayLady2,
      ThirdMixedhomeMan: req.body.ThirdMixedhomeMan3,
      ThirdMixedhomeLady: req.body.ThirdMixedhomeLady3,
      ThirdMixedawayMan: req.body.ThirdMixedawayMan3,
      ThirdMixedawayLady: req.body.ThirdMixedawayLady3,
      ...Object.fromEntries(
