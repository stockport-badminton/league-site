...
function containsDodgyEmail(value,{req}){
  var substringsArray = ["bfifield@yahoo.com","moqagides18@gmail.com","winsatall4ever@gmail.com","june_mandap@yahoo.com","arikerer278@gmail.com","yawiviseya67@gmail.com","ixutikob077@gmail.com","jamescook312@outlook.com","axobajigufo34@gmail.com","kayleighbpsteamship@gmail.com","yjdisantoyjdissemin@gmail.com","lucido.leinteract@gmail.com","projectdept@kanzalshamsprojectmgt.com","evalidator.test@gmail.com","simpsonmiddleton1111@gmail.com","simpsonmiddleton@bankingandfinanceconsultantsltd.com","breiner@cljfarmaceutisch.nl","drbreiner233@gmail.com","smithduncan610@gmail.com","5rdhp2fe29yb@beconfidential.com","stevenlove88@163.com","artweb.agency@gmail.com","help@aweb.sbs","hrhbah-mbi@aghemfondom.com","hrhmbambi@gmail.com","nhu-tran@sac-city.k12.ca.us","yourmail@gmail.com","kaenquirynicholls@gmail.com"];
...
exports.distribution_list = async function(req,res,next) {
  ...
  if (typeof req.headers['x-amz-sns-message-type'] !== 'undefined' && req.headers['x-amz-sns-message-type'] == 'SubscriptionConfirmation'){
    console.log(`found message header: ${req.body}`)
    ...
    console.log(`didn't find message header: ${req.body}`)
  }
