> **Copied into league-site 1 Sep 2026 for the record.** The original lives at
> `docs/handover/s3-bucket-reply-to-stockport.md` in the
> [tameside](https://github.com/stockport-badminton/tameside) repo; this copy is here
> because HARD-02b's step 3 now depends on the decision below, and a future session in
> this repo will not have that one checked out. It is their document — if the two ever
> disagree, theirs is authoritative.
